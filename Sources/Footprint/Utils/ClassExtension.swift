...
public extension VaultData {
    ...
    static func createVault( idAddressLine1: String? = nil,
                             ...
                             idNationality: VaultData.IdNationality? = nil,
                             idPhoneNumber: String? = nil,
                             idSsn4: String? = nil,
                             idSsn9: String? = nil,
                             idState: String? = nil,
                             idUsLegalStatus: VaultData.IdUsLegalStatus? = nil,
                             idUsTaxId: String? = nil,
                             idVisaExpirationDate: String? = nil,
                             idVisaKind: VaultData.IdVisaKind? = nil,
                             idZip: String? = nil,
                             investorProfileAnnualIncome: VaultData.InvestorProfileAnnualIncome? = nil,
                             ...
                             investorProfileEmploymentStatus: VaultData.InvestorProfileEmploymentStatus? = nil,
                             ...
                             investorProfileNetWorth: VaultData.InvestorProfileNetWorth? = nil,
                             investorProfileOccupation: String? = nil,
                             investorProfilePoliticalOrganization: String? = nil,
                             investorProfileRiskTolerance: VaultData.InvestorProfileRiskTolerance? = nil,
