...
export const CollectedKybDataOptionToRequiredAttributes: Record<CollectedKybDataOption, BusinessDI[]> = {
...
export const CollectedKycDataOptionToRequiredAttributes: Record<CollectedKycDataOption, IdDI[]> = {
  ...
  [CollectedKycDataOption.fullAddress]: [IdDI.addressLine1, IdDI.city, IdDI.state, IdDI.zip, IdDI.country],
