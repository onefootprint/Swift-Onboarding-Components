...
open class ApiClient(
    ...
    private val authentications: kotlin.collections.Map<String, Authentication> by lazy {
        mapOf(
                ...
                "sdkArgsToken" to ApiKeyAuth("header", "X-Fp-Sdk-Args-Token"), 
                "sessionToken" to ApiKeyAuth("header", "X-Fp-Authorization"), 
                "userOnboardingToken" to ApiKeyAuth("header", "X-Fp-Authorization"), 
                "userToken" to ApiKeyAuth("header", "X-Fp-Authorization"))
    }
