...
read -p "Secret value: " secretValue

pulumi config set --secret --path "constants.$secretName" $secretValue
echo "Secret set!"

echo "Reading secret for verification"
pulumi config get --path "constants.$secretName"