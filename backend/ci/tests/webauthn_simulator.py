...
Adapted from https://github.com/bodik/soft-webauthn/blob/ae35f03d47ec62f73ab2c87a3e0d752d9c2230dc/soft_webauthn.py
"""
...
class SoftWebauthnDevice:
    ...
    def create(self, options, origin):
        ...
        flags = b"\x45"  # attested_data + user_present + user verified
