...
def skip_kyc_playbook(sandbox_tenant, must_collect_data):
    return create_ob_config(
        ...
        must_collect_data
        + ["business_name", "business_address", "business_beneficial_owners"],
        skip_kyc=True,
...
def test_skip_kyc(sandbox_tenant, skip_kyc_playbook):
    """
...
def test_skip_kyc_status_unchanged(sandbox_tenant, skip_kyc_playbook):
