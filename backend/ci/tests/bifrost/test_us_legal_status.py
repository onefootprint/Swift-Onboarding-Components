...
def test_us_legal_status(legal_status_obc, twilio, data):
    bifrost = BifrostClient.new(legal_status_obc, twilio)
    bifrost.data = {
        **bifrost.data,
        **data,
    }
...
def test_invalid_us_legal_status(legal_status_obc, twilio, data):
    bifrost = BifrostClient.new(legal_status_obc, twilio)
    bifrost.data = {
        **bifrost.data,
        **data,
