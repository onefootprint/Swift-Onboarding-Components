  ...
  async params => {
    ...
    let query = `
      ...
      select 
        ...
        psv.sv_created_at, psv.sv_status, wf.wf_created_at, wf.wf_status, wf.wf_id
      ...
      where 
        ...
        and greatest(psv.sv_created_at, wf.wf_created_at) >= now() - interval '3 day'
        and greatest(psv.sv_created_at, wf.wf_created_at) < now() - interval '2 minute'
    `;
