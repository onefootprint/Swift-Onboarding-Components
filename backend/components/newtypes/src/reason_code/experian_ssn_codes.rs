...
experian_reason_code_enum! {
    ...
    pub enum ExperianSSNReasonCodes {
        ...
        #[ser = "EQ"]
        #[footprint_reason_codes =  ExpSsnRCH::new(Ssn9(Exact), FullNameSimple(NoMatch), FullAddressSimple(Partial)).into()]
        EQ,
        ...
        #[ser = "FH"]
        #[footprint_reason_codes =  ExpSsnRCH::new(Ssn9(NoMatch), FullNameSimple(Partial), FullAddressSimple(Partial)).into()]
        FH,
        ...
        #[ser = "EY"]
        #[footprint_reason_codes =  ExpSsnRCH::new(Ssn9(Exact), FullNameSimple(NoMatch), FullAddressSimple(NoMatch)).into()]
        EY,
        ...
        #[ser = "CQ"]
        #[footprint_reason_codes =  ExpSsnRCH::new(Ssn9(Partial), FullNameSimple(NoMatch), FullAddressSimple(Partial)).into()]
        CQ,
        ...
        #[ser = "CY"]
        #[footprint_reason_codes =  ExpSsnRCH::new(Ssn9(Partial), FullNameSimple(NoMatch), FullAddressSimple(NoMatch)).into()]
        CY,
        ...
        #[ser = "QA"]
        #[footprint_reason_codes = ExpSsnRCH::new(Ssn9ExactMatchSubjectDeceased, FullNameSimple(Exact), FullAddressSimple(Exact)).into()]
        QA,
        // Exact SSN match (input SSN reported as deceased), Exact Name match, Close Address match
        #[ser = "QB"]
        #[footprint_reason_codes = ExpSsnRCH::new(Ssn9ExactMatchSubjectDeceased, FullNameSimple(Exact), FullAddressSimple(Partial)).into()]
        QB,
        // Exact SSN match (input SSN reported as deceased), Close Name match, Exact Address match
        #[ser = "QC"]
        #[footprint_reason_codes = ExpSsnRCH::new(Ssn9ExactMatchSubjectDeceased, FullNameSimple(Partial), FullAddressSimple(Exact)).into()]
        QC,
        ...
        #[ser = "QE"]
        #[footprint_reason_codes = ExpSsnRCH::new(Ssn9ExactMatchSubjectDeceased, FullNameSimple(Exact), FullAddressSimple(NoMatch)).into()]
        QE,
        ...
        #[ser = "QH"]
        #[footprint_reason_codes = ExpSsnRCH::new(Ssn9ExactMatchSubjectDeceased, FullNameSimple(Partial), FullAddressSimple(Partial)).into()]
        QH,
        ...
        #[ser = "OK"]
        #[footprint_reason_codes = ExpSsnRCH::new(Ssn9ExactMatchSubjectDeceased, FullNameSimple(NoMatch), FullAddressSimple(Exact)).into()]
        QK,
        ...
        #[ser = "QN"]
        #[footprint_reason_codes = ExpSsnRCH::new(Ssn9ExactMatchSubjectDeceased, FullNameSimple(Partial), FullAddressSimple(NoMatch)).into()]
        QN,
        ...
        #[ser = "QQ"]
        #[footprint_reason_codes = ExpSsnRCH::new(Ssn9ExactMatchSubjectDeceased, FullNameSimple(NoMatch), FullAddressSimple(Partial)).into()]
        QQ,
        ...
        #[ser = "QY"]
        #[footprint_reason_codes = ExpSsnRCH::new(Ssn9ExactMatchSubjectDeceased, FullNameSimple(NoMatch), FullAddressSimple(NoMatch)).into()]
        QY,
        ...
        #[ser = "RA"]
        #[footprint_reason_codes =  ExpSsnRCH::new(Ssn9PartialMatchSubjectDeceased, FullNameSimple(Exact), FullAddressSimple(Exact)).into()]
        RA,

        // Close SSN match (input SSN reported as deceased), Exact Name match, Close Address match
        #[ser = "RB"]
        #[footprint_reason_codes =  ExpSsnRCH::new(Ssn9PartialMatchSubjectDeceased, FullNameSimple(Exact), FullAddressSimple(Partial)).into()]
        RB,

        // Close SSN match (input SSN reported as deceased), Close Name match, Exact Address match
        #[ser = "RC"]
        #[footprint_reason_codes =  ExpSsnRCH::new(Ssn9PartialMatchSubjectDeceased, FullNameSimple(Partial), FullAddressSimple(Exact)).into()]
        RC,
        ...
        #[ser = "RE"]
        #[footprint_reason_codes =  ExpSsnRCH::new(Ssn9PartialMatchSubjectDeceased, FullNameSimple(Exact), FullAddressSimple(NoMatch)).into()]
        RE,
        ...
        #[ser = "RH"]
        #[footprint_reason_codes =  ExpSsnRCH::new(Ssn9PartialMatchSubjectDeceased, FullNameSimple(Partial), FullAddressSimple(Partial)).into()]
        RH,
        ...
        #[ser = "RN"]
        #[footprint_reason_codes =  ExpSsnRCH::new(Ssn9PartialMatchSubjectDeceased, FullNameSimple(Partial), FullAddressSimple(NoMatch)).into()]
        RN,
        ...
        #[ser = "4Q"]
        #[footprint_reason_codes =  ExpSsnRCH::new(Ssn4ExactMatch, FullNameSimple(NoMatch), FullAddressSimple(Partial)).into()]
        FourQ,
        ...
        #[ser = "4Y"]
        #[footprint_reason_codes =  ExpSsnRCH::new(Ssn4ExactMatch, FullNameSimple(NoMatch), FullAddressSimple(NoMatch)).into()]
        FourY,
