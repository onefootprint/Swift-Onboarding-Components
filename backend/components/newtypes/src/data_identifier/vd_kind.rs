...
impl From<PersonVaultDataKind> for VdKind {
    fn from(value: PersonVaultDataKind) -> Self {
        VdKind::Id(value)
    }
}

impl From<BusinessDataKind> for VdKind {
        ...
        let result = match period_idx {
            ...
            Some(period_idx) => {
                ...
                match prefix {
                    ...
                    VdKindDiscriminant::Business => Self::Business(
...
mod tests {
    ...
    #[test_case(VdKind::Id(PersonVaultDataKind::FirstName) => "id.first_name")]
    #[test_case(VdKind::Id(PersonVaultDataKind::AddressLine1) => "id.address_line1")]
    fn test_serialization(kind: VdKind) -> String {
        kind.to_string()
    }

    #[test_case("id.first_name" => VdKind::Id(PersonVaultDataKind::FirstName))]
    #[test_case("first_name" => VdKind::Id(PersonVaultDataKind::FirstName))]
    #[test_case("id.address_line1" => VdKind::Id(PersonVaultDataKind::AddressLine1))]
    #[test_case("address_line1" => VdKind::Id(PersonVaultDataKind::AddressLine1))]
