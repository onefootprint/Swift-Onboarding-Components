...
mod test {
    ...
    use newtypes::{
        ...
        DocumentSide, IdentityDataKind as IDK, KvDataKey, ModernIdDocKind, TenantScope as TS,
    };
    use std::str::FromStr;
    ...
    #[test_case(&[TS::DecryptCustom], CanDecrypt::new(vec![DI::Document(DocumentKind::Image(ModernIdDocKind::Passport, DocumentSide::Front))]) => false)]
    #[test_case(&[TS::Decrypt{data: CDO::Name}], CanDecrypt::new(vec![DI::Document(DocumentKind::Image(ModernIdDocKind::IdCard, DocumentSide::Selfie))]) => false)]
    ...
    #[test_case(&[TS::DecryptDocumentAndSelfie], CanDecrypt::new(vec![DI::Document(DocumentKind::Image(ModernIdDocKind::Passport, DocumentSide::Front))]) => true)]
    #[test_case(&[TS::DecryptDocumentAndSelfie], CanDecrypt::new(vec![DI::Document(DocumentKind::Image(ModernIdDocKind::IdCard, DocumentSide::Selfie))]) => true)]
    #[test_case(&[TS::DecryptDocument], CanDecrypt::new(vec![DI::Document(DocumentKind::Image(ModernIdDocKind::Passport, DocumentSide::Front))]) => true)]
    #[test_case(&[TS::DecryptDocument], CanDecrypt::new(vec![DI::Document(DocumentKind::Image(ModernIdDocKind::IdCard, DocumentSide::Selfie))]) => false)]
    // CanDecrypt complex
    #[test_case(&[TS::DecryptCustom, TS::Decrypt{data: CDO::Ssn9}], CanDecrypt::new(vec![DI::Id(IDK::Ssn4), DI::Document(DocumentKind::Image(ModernIdDocKind::Passport, DocumentSide::Front))]) => false)]
    ...
    #[test_case(&[TS::DecryptCustom, TS::DecryptDocumentAndSelfie, TS::Decrypt{data: CDO::Ssn9}], CanDecrypt::new(vec![DI::Id(IDK::Ssn4), DI::Custom(KvDataKey::from_str("custom.key").unwrap()), DI::Document(DocumentKind::Image(ModernIdDocKind::Passport, DocumentSide::Front))]) => true)]
    #[test_case(&[TS::DecryptCustom, TS::DecryptDocumentAndSelfie, TS::Decrypt{data: CDO::Ssn9}], CanDecrypt::new(vec![DI::Id(IDK::FirstName), DI::Custom(KvDataKey::from_str("custom.key").unwrap()), DI::Document(DocumentKind::Image(ModernIdDocKind::Passport, DocumentSide::Front))]) => false)]
    //
    // Test Or
    //
