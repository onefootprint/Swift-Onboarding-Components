...
use crate::auth::tenant::{SecretTenantAuthContext, TenantPermission};
...
pub async fn get(
    ...
    let auth = auth.check_permissions(TenantPermission::Read)?; // No permissions needed to access this endpoint
