...
ALTER TABLE workflow
    ADD CONSTRAINT ob_configuration_id_not_null CHECK(ob_configuration_id IS NOT NULL) NOT VALID;

ALTER TABLE workflow
    VALIDATE CONSTRAINT ob_configuration_id_not_null;

ALTER TABLE workflow
    ALTER COLUMN ob_configuration_id SET NOT NULL;

ALTER TABLE workflow
    DROP CONSTRAINT ob_configuration_id_not_null;