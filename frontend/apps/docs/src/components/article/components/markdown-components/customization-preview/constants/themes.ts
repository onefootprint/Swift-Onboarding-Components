...
export const themes: Theme[] = [
  {
    name: 'Footprint',
    src: 'https://id.preview.onefootprint.com?public_key=ob_live_NCIvO0m9VVlxPy2p1BwzFf',
