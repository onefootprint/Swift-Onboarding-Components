...
Click [here](https://github.com/onefootprint/examples/tree/master/frontend-react-customized) to check out a full example and [here](https://docs.onefootprint.com/kyc-with-pii/customization) for more details about customization.
...
Click [here](https://github.com/onefootprint/examples/tree/master/frontend-react-user-data) to check out a full example and [here](https://docs.onefootprint.com/kyc-with-pii/user-data) for more details about user data.
