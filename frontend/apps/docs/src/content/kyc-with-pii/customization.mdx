---
page: KYC + PII Vault
slug: /kyc-with-pii/customization
category: KYC + PII Vault
title: Customization
position: 2
meta: { title: KYC + PII Vault - Customization, description: How to customize }
---
...
<br />
Click [here](https://github.com/onefootprint/examples/tree/master/frontend-vite-vanilla)
to checkout a project example.
...
footprint.show({ publicKey, appearance });
```
