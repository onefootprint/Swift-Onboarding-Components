...
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `borderRadius`     | `buttonBorderRadius`, `dialogBorderRadius`, `inputBorderRadius`, `dropdownBorderRadius`, `radioSelectBorderRadius`                                                           |
...
The dialog is a crucial component that wraps our flow.
...
| Variable             | Description                           |
| -------------------- | ------------------------------------- |
| `dialogBg`           | Sets the dialog body background color |
| `dialogBoxShadow`    | Determines the dialog's shadow        |
| `dialogBorderRadius` | Defines the dialog's border radius    |
