...
| `investor_profile.investment_goals`        | An array of `grow_long_term_wealth`, `save_for_retirement`, `support_loved_ones`, `buy_a_home`, `pay_off_debt`, `start_my_own_business` |
| `investor_profile.risk_tolerance`          | One of `conservative`, `moderate`, `aggressive`                                                                                         |
| `investor_profile.declarations`            | An array of `affiliated_with_us_broker`, `senior_executive`, `senior_political_figure`, `family_of_political_figure`                    |
