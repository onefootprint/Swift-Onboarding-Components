...
```html
<div id="footprint-button" data-public-key="ob_test_VMooXd04EUlnu3AvMYKjMW"></div>
```
...
<inline-alert variant="info">
  Save both `fp_id`s in your database tied to the user and business. These are the
  identifiers you will send to request any user- or business-specific information.
</inline-alert>
