...
Please ensure you are familiar with our [server-side API authentication guide](/integrate/api-authentication) to securely connect to the Footprint API from your backend.
