...
First of all, make sure you have followed the [KYC guide](/guides/onboarding-components-kyc). The KYB process should be similar to the KYC and you'll need to collect Business and Business Owner information. [Here](https://demo.onefootprint.com/kyb/onboarding-components) you can find a live demo.
