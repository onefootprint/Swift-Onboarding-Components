---
page: default
slug: /articles/sdks/flutter-hosted
category: SDKs
subcategory: Flutter
title: Onboarding (Hosted flow)
meta:
  {
    title: "Footprint Flutter Hosted Flow Integration",
    description: "Discover how to integrate Footprint hosted flow with a Flutter Codebase",
  }
---
...
Utilize the `bootstrapData` field in `FootprintConfiguration` to pre-fill any available data and bypass completed pages for your users and businesses. You can click [here](/articles/integrate/bootstrap-data) to find out more about the formatting and validation requirements we have for these inputs.
