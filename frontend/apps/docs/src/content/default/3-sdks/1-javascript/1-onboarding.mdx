---
page: default
slug: /articles/sdks/js-onboarding
category: SDKs
subcategory: Javascript/Typescript
title: Onboarding (KYC/KYB)
meta:
  {
    title: Footprint | JS/TS Integration - Onboarding (KYC/KYB),
    description: Discover how to integrate Footprint's Onboarding (KYC/KYB) flow into your JS/TS application.,
  }
---
