...
Utilize the `bootstrapData` option to pre-fill any available data and bypass completed pages for your users. For complete details, click [here](https://docs.onefootprint.com/integrate/bootstrap-data).
