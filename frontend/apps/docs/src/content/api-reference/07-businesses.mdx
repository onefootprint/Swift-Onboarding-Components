...
apis:
  ...
  - method: patch
    ...
    description: Update basic details for a business. See the APIs under the <ScrollLink id="business-vault">Business vault</ScrollLink> section for information on patching vault data.
  - method: get
    path: /businesses
