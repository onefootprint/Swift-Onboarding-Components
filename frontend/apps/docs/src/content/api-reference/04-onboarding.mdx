...
apis:
  ...
  - method: get
    path: /users/{fp_id}/duplicates
    title: List all users with duplicate attributes
    description:  Returns list of users with duplicate attributes to the provided user. Includes tags and label values for each user that shares duplicate attributes.
