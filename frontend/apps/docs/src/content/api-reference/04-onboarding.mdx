...
apis:
  ...
  - method: post
    ...
    description: When you have bootstrap data available on your backend, generates a short-lived token that can be passed into the Footprint SDK to represent all data.
  - method: post
