...
<CaseStudyLayout
  companyDetails={{
    ...
    logo: "/customer-stories/bloom-logo.png",
    customerSince: "2023",
    title: "Footprint helps Bloom increase onboarding completions by 150%",
...
- Whereas Bloom previously saw a 60% abandonment rate, now 90% of users that required identity document collection successfully completed the onboarding and uploaded documents, **a 150% increase**.
