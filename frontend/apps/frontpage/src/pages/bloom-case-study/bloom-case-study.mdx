...
<CaseStudyLayout
  companyDetails={{
    ...
    subtitle: "Through Footprint's integration, Bloom significantly enhanced its onboarding process, leading to an increase in completions and earning recognition from top publications."
}}>
...
- Whereas Bloom previously saw a 60% abandonment rate, now 90% of users that required identity document collection successfully completed the onboarding and uploaded documents - **_a 150% increase_**.
