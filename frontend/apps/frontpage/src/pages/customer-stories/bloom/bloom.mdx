...
<SEO
  ...
  image="/customer-stories/bloom/bloom-og.png"
  og={{
    image: '/customer-stories/bloom/bloom-og.png',
  }}
  twitter={{
...
<CaseStudyLayout
  companyDetails={{
    ...
    logo: "/customer-stories/bloom/bloom-logo.png",
    customerSince: "2023",
...
- 90% of users that required identity document collection successfully completed the onboarding and uploaded documents, a **150% increase**.
