...
import PhoneRegistrationEmailPreview, {
  PhoneRegistrationEmailPreviewProps,
} from './phone-registration-email-preview';

describe('<PhoneRegistrationEmailPreview />', () => {
  const renderPreview = ({
    email,
    onChange = () => {},
  }: Partial<PhoneRegistrationEmailPreviewProps>) =>
    customRender(
      <PhoneRegistrationEmailPreview email={email} onChange={onChange} />,
    );
