...
import PhoneIdentificationEmailPreview, {
  PhoneIdentificationEmailPreviewProps,
} from './phone-identification-email-preview';

describe('<PhoneIdentificationEmailPreview />', () => {
  const renderPreview = ({
    email,
    onChange = () => {},
  }: Partial<PhoneIdentificationEmailPreviewProps>) =>
    customRender(
      <PhoneIdentificationEmailPreview email={email} onChange={onChange} />,
    );
