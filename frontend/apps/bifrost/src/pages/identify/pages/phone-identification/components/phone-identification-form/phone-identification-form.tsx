...
import PHONE_REGEX from './phone-identification-form.constants';

type FormData = {
  [UserDataAttribute.phoneNumber]: string;
};

export type PhoneIdentificationFormProps = {
  defaultPhone?: string;
  isLoading?: boolean;
  onSubmit: (formData: FormData) => void;
};

const PhoneIdentificationForm = ({
  isLoading,
  defaultPhone,
  onSubmit,
}: PhoneIdentificationFormProps) => {
...
export default PhoneIdentificationForm;
