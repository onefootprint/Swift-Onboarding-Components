...
export const withMetadata = (userId: string, data = metadataFixture) =>
  mockRequest({
    method: 'get',
    path: `/users/${userId}`,
    response: { data },
...
export const withRiskSignals = (userId: string, data = []) =>
  mockRequest({
    method: 'get',
...
export const withAnnotations = (userId: string, data = []) =>
  mockRequest({
    method: 'get',
    path: `/users/${userId}/annotations`,
    response: { data },
  });

export const withLiveness = (userId: string, data = []) =>
  mockRequest({
    method: 'get',
    path: `/users/${userId}/liveness`,
    response: { data },
  });
