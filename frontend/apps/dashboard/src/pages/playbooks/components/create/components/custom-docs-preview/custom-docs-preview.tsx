...
const CustomDocsPreview = ({ name, uploadSettings, identifier, ...props }: CustomDocsPreviewProps) => {
  const { t } = useTranslation('playbooks', { keyPrefix: 'create.custom-docs' });

  return (
    <Stack flexDirection="column" gap={4} {...props}>
