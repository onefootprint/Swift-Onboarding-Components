...
describe('getEntityDataForListKind', () => {
  it('should return email address', () => {
    ...
    expect(
      getEntityDataForListKind(
        ListKind.emailAddress,
        EntityKind.person,
        vaultData,
      ),
    ).toEqual(['piip@onefootprint.com']);
    expect(
      getEntityDataForListKind(
    ...
    expect(
      getEntityDataForListKind(ListKind.ssn9, EntityKind.person, vaultData),
    ).toEqual([]);
    expect(
      getEntityDataForListKind(
        ListKind.ipAddress,
  ...
  it('should return phone number', () => {
    ...
    expect(
      getEntityDataForListKind(ListKind.ssn9, EntityKind.business, vaultData),
    ).toEqual([]);
    expect(
      getEntityDataForListKind(
        ListKind.ipAddress,
    ...
    expect(
      getEntityDataForListKind(ListKind.ssn9, EntityKind.person, userVaultData),
    ).toEqual([]);
    expect(
      getEntityDataForListKind(
        ListKind.ipAddress,
