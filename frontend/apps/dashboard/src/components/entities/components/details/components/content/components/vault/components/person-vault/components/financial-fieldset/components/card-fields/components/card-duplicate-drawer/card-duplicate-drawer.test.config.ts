...
const allMatchingDupesFixture: DuplicateDataItem[] = [
  {
    dupeKinds: [DupeKind.cardNumberCvc],
    fpId: 'fp_id_1',
    status: EntityStatus.pass,
    startTimestamp: '2024-10-05T00:09:46.854697Z',
    data: [
      {
        identifier: 'card.Primary.fingerprint' as DataIdentifier,
        source: 'tenant',
        isDecryptable: true,
  ...
  },
  {
    ...
    data: [
      {
        identifier: 'card.Secondary.fingerprint' as DataIdentifier,
        source: 'tenant',
        isDecryptable: true,
        dataKind: DataKind.vaultData,
        value: 'fingerprint1',
  ...
  },
  {
    ...
    data: [
      {
        identifier: 'card.Tertiary.fingerprint' as DataIdentifier,
        source: 'tenant',
        isDecryptable: true,
        dataKind: DataKind.vaultData,
        value: 'fingerprint1',
