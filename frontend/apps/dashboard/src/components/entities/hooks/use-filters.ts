...
const useFilters = () => {
  ...
  const requestParams = {
    ...
    timestampGte: from,
    timestampLte: to,
    watchlistHit: values.watchlist_hit,
    hasOutstandingWorkflowRequest: values.has_outstanding_workflow_request,
    showUnverified: values.show_unverified,
    showAll: values.show_unverified,
    playbookIds: values.playbook_ids,
