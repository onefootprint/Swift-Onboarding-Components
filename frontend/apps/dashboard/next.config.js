...
const getNextConfig = () => {
  ...
  const DevContentSecurityPolicy = `
    ...
    img-src 'self' blob: data: assets.vercel.com vercel.live vercel.com *.googleapis.com maps.gstatic.com i.onefp.net i-dev.onefp.net *.i-dev.onefp.net assets.calendly.com https://cdn.jsdelivr.net;
