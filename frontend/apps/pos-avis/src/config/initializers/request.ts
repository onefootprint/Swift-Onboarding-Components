...
import { OB_CONFIG_KEY, SHOULD_USE_DEV } from '../../config/constants';
import createSandboxId from '../../utils/create-sandbox-id';

const OVERRIDE_API_HOST_PARAM = 'apiHost';
const DEFAULT_API_URL = SHOULD_USE_DEV ? 'https://api.dev.onefootprint.com' : 'https://api.onefootprint.com';
...
client.setConfig({
  ...
  headers: {
    ...
    'X-Onboarding-Config-Key': OB_CONFIG_KEY,
    // TODO: Remove
