...
const ContentSecurityPolicy = `
  ...
  connect-src 'self' *.onefootprint.com ${DEV_CONNECT_SRC} vitals.vercel-insights.com *.usefathom.com *.pusher.com wss://*.pusher.com vercel.live unpkg.com *.neuro-id.com *.neuroid.cloud;
