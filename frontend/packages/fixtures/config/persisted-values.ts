export const persistedValues: Record<string, unknown> = {
  ...
  'dashboard.AuditEventDetail': {
    data: {
      ...
      first_name: 'ad nisi ex minim',
      fp_id: 'aute laborum irure',
      last_name: 'dolore incididunt elit',
      list_entry_id: 'sed sint et',
      list_id: 'Ut ea',
      new_role: {
        created_at: '1962-01-24T21:16:34.0Z',
        id: 'sed consequat dolor fugiat',
        is_immutable: false,
        kind: 'api_key',
        name: 'nostrud sunt',
        num_active_api_keys: -35810516,
        num_active_users: -24054848,
        scopes: [
          {
            kind: 'write_lists',
          },
      ...
      old_role: {
        created_at: '1930-01-29T15:22:37.0Z',
        id: 'occaecat voluptate et',
        is_immutable: true,
        kind: 'dashboard_user',
        name: 'elit esse fugiat',
        num_active_api_keys: 6820060,
        num_active_users: -92865090,
        scopes: [
          {
            kind: 'onboarding',
          },
      ...
      role_name: 'Lorem consectetur proident',
      scopes: [
        {
      ...
      tenant_role_id: 'eiusmod ex ipsum occaecat minim',
      tenant_user_id: 'ullamco nisi velit nostrud',
    },
  ...
  'dashboard.Document': {
    ...
    samba_activity_history_completed_version: 14441396,
  ...
  'dashboard.EntityAction': {
    ...
    trigger: {
      data: {
        ...
        playbook_id: 'eu exercitation reprehenderit Excepteur laboris',
        recollect_attributes: ['dob', 'business_phone_number', 'business_address'],
  ...
  'dashboard.InsightRegistration': {
    ...
    registered_agent: 'id exercitation ad',
  ...
  'dashboard.ListEvent': {
    ...
    insight_event: {
      ...
      time_zone: 'Excepteur voluptate ut occaecat sed',
  ...
  'dashboard.TriggerRequest': {
    ...
    trigger: {
      data: {
        ...
        playbook_id: 'consectetur',
        recollect_attributes: ['business_address', 'email', 'business_tin'],
        reuse_existing_bo_kyc: true,
      },
      kind: 'document',
    },
    ...
    data: {
      ...
      config: {
        data: {
          ...
          playbook_id: 'labore anim id est',
          recollect_attributes: ['dob', 'ssn9', 'email'],
      ...
      insight_event: {
        city: 'dolore',
        ip_address: 'laborum voluptate ex dolore commodo',
        latitude: 91947249.93068042,
        longitude: 74174514.09754801,
        metro_code: 'proident do',
        region_name: 'proident nulla Ut',
        session_id: 'commodo quis dolor',
  ...
  'dashboard.VaultCreated': {
    actor: {
      email: 'consequat',
      first_name: 'non eiusmod',
      kind: 'firm_employee',
      last_name: 'dolore ea sed amet reprehenderit',
  ...
  'dashboard.WorkflowRequestConfig': {
    data: {
      ...
      playbook_id: 'do',
      recollect_attributes: ['business_website', 'investor_profile', 'business_name'],
      reuse_existing_bo_kyc: false,
    },
    kind: 'document',
  },
