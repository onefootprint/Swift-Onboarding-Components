...
export const hosted_BootstrapDataV1: BootstrapDataV1 = {
...
export const hosted_ChallengeRequest: ChallengeRequest = {
  challengeKind: 'email',
};
export const hosted_ChallengeVerifyRequest: ChallengeVerifyRequest = {
...
export const hosted_IdentifyRequirement: IdentifyRequirement = {
  cdo: 'business_website',
  kind: 'collect_data',
};
export const hosted_IdentifyRequirementChallenge: IdentifyRequirementChallenge = {
  authMethod: 'phone',
  challengeKinds: ['sms_link', 'email', 'email'],
  kind: 'challenge',
};
export const hosted_IdentifyRequirementCollectData: IdentifyRequirementCollectData = {
  cdo: 'business_address',
  kind: 'collect_data',
};
export const hosted_IdentifyRequirementLogin: IdentifyRequirementLogin = {
  kind: 'login',
  user: {
    authMethods: [
      {
...
export const hosted_IdentifyRequirementsResponse: IdentifyRequirementsResponse = {
  requirements: [
    {
      cdo: 'phone_number',
      kind: 'collect_data',
...
export const hosted_IdentifySessionRequest: IdentifySessionRequest = {
  data: {
...
export const hosted_IdentifySessionResponse: IdentifySessionResponse = {
...
export const hosted_Language: Language = 'es';
...
export const hosted_Locale: Locale = 'es-MX';
...
export const hosted_VaultData: VaultData = {
...
export const dashboard_CursorPaginatedUserTimeline: CursorPaginatedUserTimeline = {
  data: [
    {
      event: {
        data: {
...
export const dashboard_UpdatePlaybookRequest: UpdatePlaybookRequest = {
  status: 'disabled',
};
