  ...
  merge(
    {
      ...
      invitedData: {
        ...
        'document.drivers_license.address_line1': '1305 Rodolfo Rapids Suite 771',
        'document.drivers_license.back.image': 'qui reprehenderit dolor Ut',
        'document.drivers_license.back.mime_type': 'et',
        'document.drivers_license.city': 'South Shaniyaside',
        ...
        'document.drivers_license.first_name': 'Kaitlyn',
        ...
        'document.drivers_license.last_name': 'Auer',
        ...
        'document.id_card.city': 'Port Willland',
        ...
        'document.id_card.first_name': 'Conner',
        ...
        'document.id_card.last_name': 'Gleason',
        'document.id_card.nationality': '5df95a58-0d18-437b-86cb-a5209d888b5e',
        'document.id_card.postal_code': 'dd5aa8e0-12df-456c-989b-2f5d83a7a3ad',
        ...
        'document.passport.last_name': 'Deckow',
        ...
        'document.passport_card.first_name': 'Bryon',
        ...
        'document.passport_card.last_name': 'Mann',
        ...
        'document.passport_card.state': 'Nebraska',
        'document.permit.address_line1': '9382 Stacy Gardens Apt. 188',
        'document.permit.back.image': 'aliquip',
        'document.permit.back.mime_type': 'occaecat dolor ex non',
        'document.permit.city': 'West Jovannyworth',
        ...
        'document.permit.first_name': 'Nella',
        ...
        'document.permit.last_name': 'Langworth',
        ...
        'document.residence_document.city': 'Cummeratahaven',
        ...
        'document.residence_document.first_name': 'Meta',
        ...
        'document.residence_document.last_name': 'Ullrich',
        ...
        'document.visa.first_name': 'Gerson',
        ...
        'document.visa.last_name': 'Rohan',
        'document.visa.nationality': 'Duis commodo Excepteur dolor minim',
        'document.visa.postal_code': 'minim commodo',
        ...
        'document.visa.state': 'South Dakota',
        'document.voter_identification.address_line1': '349 Shad Field Apt. 502',
        ...
        'document.voter_identification.city': 'Reichertfurt',
        ...
        'document.voter_identification.last_name': 'Robel',
        'document.voter_identification.nationality': 'bf0fd55d-7e22-4adb-9073-fe5aea9dd94a',
        'document.voter_identification.postal_code': '2a80fc5b-8e66-4b39-96ff-81edad303b24',
  ...
  merge(
    {
      ...
      decryptedData: {
        ...
        'document.drivers_license.address_line1': '38151 Friesen Expressway Suite 342',
        ...
        'document.drivers_license.last_name': 'Mayer',
        'document.drivers_license.nationality': 'velit elit',
        'document.drivers_license.postal_code': 'voluptate est anim dolore',
        ...
        'document.id_card.address_line1': '4202 Kennith Landing Suite 111',
        ...
        'document.id_card.city': 'Jastfort',
        ...
        'document.id_card.postal_code': '763b8fa5-a4fd-40b3-8152-16d8040c0ea0',
        ...
        'document.id_card.state': 'Illinois',
        'document.passport.address_line1': '885 N Jefferson Street Suite 109',
        'document.passport.back.image': 'dolore irure occaecat dolor',
        'document.passport.back.mime_type': 'labore qui ut ea occaecat',
        'document.passport.city': 'Lake Lailaworth',
        ...
        'document.passport.first_name': 'Aglae',
        ...
        'document.passport.postal_code': 'in est',
        ...
        'document.passport.state': 'Arkansas',
        'document.passport_card.address_line1': '200 Adams-Schamberger Branch Apt. 673',
        'document.passport_card.back.image': 'Duis do tempor Ut Lorem',
        'document.passport_card.back.mime_type': 'in fugiat Duis Ut',
        'document.passport_card.city': 'Fort Jody',
        ...
        'document.passport_card.first_name': 'Tony',
        ...
        'document.passport_card.last_name': 'King',
        ...
        'document.permit.postal_code': 'ea occaecat qui fugiat',
        ...
        'document.permit.state': 'Texas',
        'document.proof_of_address.image': '1824 Broad Street Apt. 318',
        'document.residence_document.address_line1': '50128 Sedrick Prairie Apt. 506',
        ...
        'document.residence_document.city': 'Torranceville',
        ...
        'document.residence_document.postal_code': '6760a283-bc96-4662-82e1-b8db0424eb20',
        ...
        'document.visa.address_line1': '35885 N 3rd Street Apt. 104',
        'document.visa.back.image': 'veniam sit minim est',
        'document.visa.back.mime_type': 'ut',
        'document.visa.city': 'North Marilie',
        ...
        'document.visa.first_name': 'Elnora',
        ...
        'document.voter_identification.city': 'Dakotatown',
        ...
        'document.voter_identification.postal_code': 'f0ca0d93-c793-4bb6-b22f-ab636486e16d',
  ...
  merge(
    {
      ...
      'document.drivers_license.city': 'Mayertchester',
      ...
      'document.drivers_license.first_name': 'Torrey',
      ...
      'document.drivers_license.last_name': 'Oberbrunner',
      'document.drivers_license.nationality': 'ea deserunt esse consectetur Duis',
      'document.drivers_license.postal_code': 'et consectetur sint',
      ...
      'document.id_card.city': 'East Jammieton',
      ...
      'document.id_card.first_name': 'Eli',
      ...
      'document.id_card.last_name': 'Flatley',
      'document.id_card.nationality': '4440ef7e-fba1-4186-86b6-65c0c5e26b9a',
      'document.id_card.postal_code': '67e0cb9e-f913-41fe-a815-2574cfc74e14',
      ...
      'document.id_card.state': 'Utah',
      'document.passport.address_line1': '4523 East Street Suite 894',
      'document.passport.back.image': 'voluptate laborum',
      'document.passport.back.mime_type': 'sint Duis dolor labore est',
      'document.passport.city': 'Pourosside',
      ...
      'document.passport.first_name': 'Laila',
      ...
      'document.passport.last_name': 'Kuhn',
      'document.passport.nationality': 'dolor consectetur',
      'document.passport.postal_code': 'consequat in nisi exercitation',
      ...
      'document.passport_card.city': 'Kubworth',
      ...
      'document.passport_card.first_name': 'Darwin',
      ...
      'document.passport_card.postal_code': 'anim sed ipsum',
      ...
      'document.permit.last_name': 'Hilpert',
      'document.permit.nationality': 'voluptate dolore',
      'document.permit.postal_code': 'eu sit',
      ...
      'document.permit.state': 'West Virginia',
      'document.proof_of_address.image': '752 Boyle Trace Apt. 261',
      'document.residence_document.address_line1': '25354 Damon Forge Suite 425',
      ...
      'document.residence_document.city': 'North Vaughnworth',
      ...
      'document.residence_document.first_name': 'Alyce',
      ...
      'document.residence_document.issuing_state': 'Maine',
      'document.residence_document.last_name': 'Muller',
      'document.residence_document.nationality': 'cc5ad914-988e-4df4-a919-2a5a61d2dde9',
      'document.residence_document.postal_code': 'ac09b166-33db-4abf-9e28-f926f17af26c',
      ...
      'document.residence_document.state': 'Montana',
      'document.ssn_card.image': 'pariatur dolore laborum nostrud sunt',
      'document.visa.address_line1': '59195 Perry Cliffs Suite 227',
      ...
      'document.visa.first_name': 'Verla',
      ...
      'document.visa.last_name': 'Ernser',
      'document.visa.nationality': 'eu',
      'document.visa.postal_code': 'ut in in cillum nostrud',
      ...
      'document.visa.state': 'North Dakota',
      'document.voter_identification.address_line1': '72291 Tremayne Oval Suite 701',
      ...
      'document.voter_identification.first_name': 'Santos',
      ...
      'document.voter_identification.last_name': 'Wolff',
      'document.voter_identification.nationality': 'aedeca19-72da-458a-895c-a357f3cedadd',
      'document.voter_identification.postal_code': 'ba784264-7670-4945-92c5-55039d3b3323',
      ...
      'document.voter_identification.state': 'Nevada',
  ...
  merge(
    {
      ...
      'document.drivers_license.address_line1': '360 County Road Suite 989',
      ...
      'document.drivers_license.city': 'South Americo',
      ...
      'document.drivers_license.first_name': 'Lemuel',
      ...
      'document.drivers_license.last_name': 'Halvorson',
      'document.drivers_license.nationality': 'occaecat quis',
      'document.drivers_license.postal_code': 'anim tempor',
      ...
      'document.id_card.address_line1': '4031 Robert Rue Suite 352',
      ...
      'document.id_card.city': 'Auerfield',
      ...
      'document.id_card.first_name': 'Anabelle',
      ...
      'document.id_card.last_name': 'Cole',
      'document.id_card.nationality': 'd1d3948c-728a-4a43-b396-3dab904419b6',
      'document.id_card.postal_code': '05a8ff4c-fac8-4a26-b3f2-fcf6179a4508',
      ...
      'document.id_card.state': 'Minnesota',
      'document.passport.address_line1': '96926 Burdette Avenue Apt. 907',
      'document.passport.back.image': 'dolor dolore est pariatur sit',
      'document.passport.back.mime_type': 'nisi adipisicing commodo',
      'document.passport.city': 'Juneberg',
      ...
      'document.passport.first_name': 'Jaylin',
      ...
      'document.passport.last_name': 'Simonis',
      ...
      'document.passport.state': 'Tennessee',
      'document.passport_card.address_line1': '42083 Boehm Courts Suite 513',
      ...
      'document.passport_card.city': 'East Hellen',
      ...
      'document.passport_card.first_name': 'Conner',
      ...
      'document.passport_card.last_name': 'Smitham',
      'document.passport_card.nationality': 'quis ad exercitation',
      'document.passport_card.postal_code': 'ut mollit labore Duis',
      ...
      'document.passport_card.state': 'West Virginia',
      'document.permit.address_line1': '2922 Burnice Shore Suite 338',
      'document.permit.back.image': 'elit eu velit',
      'document.permit.back.mime_type': 'aute',
      'document.permit.city': 'Kundemouth',
      ...
      'document.permit.first_name': 'Lourdes',
      ...
      'document.permit.last_name': 'Luettgen',
      'document.permit.nationality': 'cupidatat sunt esse',
      'document.permit.postal_code': 'et dolore',
      ...
      'document.permit.state': 'Washington',
      'document.proof_of_address.image': '43725 Hamill Junctions Apt. 238',
      'document.residence_document.address_line1': '7197 Green Street Suite 886',
      ...
      'document.residence_document.city': 'North Tianna',
      ...
      'document.residence_document.first_name': 'Oral',
      ...
      'document.residence_document.last_name': 'Zboncak',
      'document.residence_document.nationality': '0e80e387-2056-4de6-9168-c84e46fbef05',
      'document.residence_document.postal_code': 'b96b85b7-d217-48af-b48f-7f4e10c8d8b1',
      ...
      'document.visa.first_name': 'Noelia',
      ...
      'document.voter_identification.address_line1': '286 Anabelle Oval Apt. 920',
      ...
      'document.voter_identification.city': 'North Selenaboro',
      ...
      'document.voter_identification.first_name': 'Kallie',
      ...
      'document.voter_identification.last_name': 'Ledner',
      'document.voter_identification.nationality': '7c8570e1-e913-4e17-9565-6d48de0f5134',
      'document.voter_identification.postal_code': '00a76e28-8030-48be-96fd-dcf7d68e734a',
      ...
      'document.voter_identification.state': 'Nebraska',
        ...
        businessConfigs: [
          {
            data: {
              collectSelfie: true,
              documentTypesAndCountries: {
                global: ['voter_identification', 'id_card', 'permit'],
              },
            },
            kind: 'identity',
          },
        ...
        configs: [
          ...
          },
          {
            data: {
              collectSelfie: false,
              documentTypesAndCountries: {
                global: ['visa', 'passport_card', 'drivers_license'],
              },
            },
            kind: 'identity',
          },
