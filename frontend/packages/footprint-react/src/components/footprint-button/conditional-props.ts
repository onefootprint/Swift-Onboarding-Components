...
export const getConditionalVerifyProps = (
  p: FootprintVerifyProps,
  ...
  return new TypeError(
    'Missing parameter. Please add "authToken" or "publicKey"',
  );
};
...
export const getConditionalAuthProps = (
  p: FootprintAuthProps,
): TypeError | AuthAuthTokenOnly | AuthPublicKeyOnly => {
