...
const IcoSelfie40 = ({ color = 'primary', className, testID }: IconProps) => {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M31.972 8.882a.221.221 0 0 0-.037.218l1.258 3.4c.078.213-.176.393-.35.248l-2.787-2.322a.221.221 0 0 0-.216-.038l-3.3 1.186c-.21.076-.388-.174-.246-.348l2.22-2.714a.222.222 0 0 0 .036-.217l-1.258-3.402c-.079-.212.175-.392.35-.247l2.785 2.32c.06.052.144.066.218.038l3.4-1.257c.214-.08.393.175.248.349l-2.32 2.786Z"
