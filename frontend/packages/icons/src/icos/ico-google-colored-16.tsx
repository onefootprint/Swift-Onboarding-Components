...
const IcoGoogleColored16 = ({ className, testID }: IconProps) => (
  <svg
    width={16}
    height={16}
    fill="none"
  ...
  >
    ...
    />
    <path
      d="M14.864 6.629H14.3V6.6H8v2.8h3.956a4.214 4.214 0 0 1-1.43 1.95l2.167 1.832C12.54 13.322 15 11.5 15 8c0-.47-.048-.928-.136-1.371Z"
      fill="#1976D2"
    />
  </svg>
);
export default IcoGoogleColored16;
