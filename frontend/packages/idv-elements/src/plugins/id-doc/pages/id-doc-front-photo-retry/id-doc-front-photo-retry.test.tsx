...
const renderFrontPhotoRetry = (context: MachineContext) =>
  renderPage(context, <IdDocFrontPhotoRetry />, 'frontImageRetryMobile');
...
describe('<IdDocFrontPhotoRetry />', () => {
  it('Contains the correct error messages', () => {
    ...
    const error2 = screen.getByText(
      "It looks like you uploaded the wrong side of your document. Please flip your ID and upload the front side of your driver's license from United States of America.",
    );
