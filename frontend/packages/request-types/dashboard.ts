...
export type EntityActionManualDecision = ManualDecisionRequest & {
  kind: 'manual_decision';
};
export type kind52 = 'manual_decision';
export type EntityActionResponse = EntityActionResponseTrigger;
export type EntityActionResponseTrigger = CreateTokenResponse & {
  kind: 'trigger';
};
export type kind53 = 'trigger';
export type EntityActionTrigger = TriggerRequest & {
  kind: 'trigger';
};
