...
export type kind2 = 'firm_employee';
/**
...
export type kind4 = 'organization';
/**
...
export type kind6 = 'collect_user_document';
export type AuditEventDetailCompleteUserCheckLiveness = {
  kind: 'complete_user_check_liveness';
};
export type kind7 = 'complete_user_check_liveness';
export type AuditEventDetailCompleteUserCheckWatchlist = {
  kind: 'complete_user_check_watchlist';
};
export type kind8 = 'complete_user_check_watchlist';
export type AuditEventDetailCompleteUserVerification = {
...
export type ComplianceDocData = ComplianceDocDataExternalUrl | ComplianceDocDataFileUpload;
export type ComplianceDocDataExternalUrl = {
  data: {
    url: string;
  };
  kind: 'external_url';
...
export type ComplianceDocEventTypeAssigned = {
...
export type DataIdentifier<T extends string = string> =
  | 'id.first_name'
  | 'id.middle_name'
  | 'id.last_name'
  | 'id.dob'
  ...
  | 'business.zip'
  | 'business.country'
  | `business.beneficial_owners.${T}.ownership_stake`
  | `business.beneficial_owners.${T}.id.first_name`
  | `business.beneficial_owners.${T}.id.last_name`
  | `business.beneficial_owners.${T}.id.phone_number`
  | `business.beneficial_owners.${T}.id.email`
  ...
  | `card.${T}.cvc`
  | `card.${T}.name`
  | `card.${T}.billing_address.zip`
  | `card.${T}.billing_address.country`
  ...
  | `card.${T}.fingerprint`
  | `bank.${T}.name`
  | `bank.${T}.ach_routing_number`
  | `bank.${T}.ach_account_number`
...
export type DataLifetimeSource =
  ...
  | 'prefill'
  | 'vendor';
export type DbActor = DbActorUser | DbActorTenantUser | DbActorTenantApiKey | DbActorFootprint | DbActorFirmEmployee;
export type DbActorFirmEmployee = {
  data: {
    id: string;
  };
  kind: 'firm_employee';
};
export type DbActorFootprint = {
  kind: 'footprint';
};
export type DbActorTenantApiKey = {
  data: {
    id: string;
  };
  kind: 'tenant_api_key';
 ...
 */
export type GetUserVaultResponse<T extends string = string> = {
  key:
    | 'id.first_name'
    | 'id.middle_name'
    | 'id.last_name'
...
export type _key_<T extends string = string> =
  | 'id.first_name'
  | 'id.middle_name'
  | 'id.last_name'
  | 'id.dob'
 ...
 */
export type IntegrityResponse<T extends string = string> = {
  key:
    | 'id.first_name'
    | 'id.middle_name'
    | 'id.last_name'
...
export type ListEventDetail = ListEventDetailCreateListEntry | ListEventDetailDeleteListEntry;
export type ListEventDetailCreateListEntry = {
  data: {
    entries: Array<string>;
    listEntryCreationId: string;
    listId: string;
...
export type ListEventDetailDeleteListEntry = {
  data: {
    entry: string;
    listEntryId: string;
    listId: string;
 ...
 */
export type ModernEntityDecryptResponse<T extends string = string> = ReplaceWildcard<
  {
...
export type PatchAccessRequestRequest = {
  approved: boolean;
};
...
export type RuleActionConfigFail = {
  config: {
    [key: string]: unknown;
  };
  kind: 'fail';
 ...
 */
export type TenantScopeDecrypt = {
 ...
 */
export type TenantScopeInvokeVaultProxy = {
 ...
 * re-triggering KYC
 */
export type TenantScopeManualReview = {
  kind: 'manual_review';
};
/**
...
export type UserDataIdentifier<T extends string = string> =
  | 'id.first_name'
  | 'id.middle_name'
  | 'id.last_name'
  | 'id.dob'
 ...
 * A key-value map with the corresponding decrypted values
 */
export type UserDecryptResponse<T extends string = string> = {
  key:
    | 'id.first_name'
    | 'id.middle_name'
    | 'id.last_name'
 ...
 */
export type UserDeleteResponse<T extends string = string> = {
  key:
    | 'id.first_name'
    | 'id.middle_name'
    | 'id.last_name'
...
export type UserTimelineEventAnnotation = {
  data: Annotation;
  kind: 'annotation';
};
...
export type UserTimelineEventVaultCreated = {
  data: VaultCreated;
  kind: 'vault_created';
};
...
export type VerificationCheckAml = {
  data: {
    adverseMedia: boolean;
...
export type PostBusinessesByFpBidVaultByIdentifierUploadData<T extends string = string> = {
  /**
   * Raw body
   */
  body: string;
...
export type PostEntitiesVaultByIdentifierUploadData<T extends string = string> = {
  /**
   * Raw body
   */
  body: string;
...
export type GetEntitiesByFpIdVaultData<T extends string = string> = {
  headers?: {
    /**
     * Secret API key. You can create and view your API keys in the dashboard. This key should never be sent to your client and should be treated as a secret on your server.
     */
...
export type PostEntitiesByFpIdVaultByIdentifierUploadData<T extends string = string> = {
  /**
   * Raw body
   */
  body: string;
...
export type GetPrivateAccessRequestsData = {
  headers?: {
    /**
     * Short-lived auth token for a firm-employee dashboard user.
     */
    'X-Fp-Dashboard-Authorization'?: string;
  };
  query?: {
...
export type GetPrivateAccessRequestsResponse = Array<AccessRequest>;
export type GetPrivateAccessRequestsError = unknown;
export type PostPrivateAccessRequestsData = {
...
export type PostPrivateAccessRequestsResponse = AccessRequest;
export type PostPrivateAccessRequestsError = unknown;
export type PatchPrivateAccessRequestsByRequestIdData = {
  body: PatchAccessRequestRequest;
  headers?: {
    /**
     * Short-lived auth token for a firm-employee dashboard user.
     */
...
export type PatchPrivateAccessRequestsByRequestIdResponse = AccessRequest;
export type PatchPrivateAccessRequestsByRequestIdError = unknown;
...
export type $OpenApiTs = {
  ...
  '/private/access_requests': {
    get: {
      req: GetPrivateAccessRequestsData;
      res: {
        /**
         * OK
         */
    ...
    post: {
      req: PostPrivateAccessRequestsData;
      res: {
        /**
         * OK
         */
  ...
  '/private/access_requests/{request_id}': {
    patch: {
      req: PatchPrivateAccessRequestsByRequestIdData;
      res: {
        /**
         * OK
         */
