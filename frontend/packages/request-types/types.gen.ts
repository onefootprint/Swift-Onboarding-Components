...
export type ApiOnboardingRequirement = {
  isMet: boolean;
 ...
 */
export type ModernBusinessDecryptResponse<T extends string = string> = ReplaceWildcard<
  {
    'business.address_line1'?: string;
    'business.address_line2'?: string;
  ...
  T
>;
export type ModernRawBusinessDataRequest<T extends string = string> = ReplaceWildcard<
  {
    'business.address_line1'?: string;
    'business.address_line2'?: string;
    'business.beneficial_owner_explanation_message'?: string;
...
export type kind23 = 'business_aml';
...
export type kind24 = 'curp_validation';
...
export type kind25 = 'identity_document';
...
export type kind31 = 'stytch_device';
 ...
 * Adhoc vendor call
 */
export type kind32 = 'adhoc_vendor_call';
...
export type PostHostedUserUploadByDocumentIdentifierData<T extends string = string> = {
  headers?: {
    /**
     * Short-lived auth token for a user during bifrost. Issued by identify and contains scopes to perform specific user actions.
     */
